...
VALIDATORS = (
    ...
    "validate_context_authority_v030.py",
    "validate_protocol_security_v030.py",
    "validate_adoption_v030.py",
    "validate_task_rigor_v030.py",
    "validate_release_bundle_v030.py",
)
