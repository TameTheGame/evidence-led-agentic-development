...
*Follow this first-run guide for `<one small task>` for `<x>` project: https://github.com/TameTheGame/evidence-led-agentic-development/edit/main/docs/FIRST_RUN.md*
